...
The first corpus covers checked lexical rejection, accepted lexical/bitwise
boundaries, and lowering after a direct return. It does NOT certify complete
grammar/type checking, general tail calls, allocation lifetime, or a repaired
CLI. The explicit `reject-legacy` profile pins the CURRENT rejection envelope
