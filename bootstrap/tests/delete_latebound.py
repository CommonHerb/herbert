...
import delete_ref as C
from delete_ref import (Asm, le32, FS_NAMELEN, FS_MAXLEN, SYS_READ, SYS_WRITE, SYS_FS_PUT, SYS_FS_GET, SYS_FS_DEL,
...
if __name__ == '__main__':
    cmd = sys.argv[1]
    if cmd == 'deleter':                # out  (BOOT-2 late-bound deleter: read a 16B name over COM1 -> SYS_FS_DEL it)
