...
def parse_head(stream):
    ...
    try:
        cd['_tail']=debugcon.FramedTail(stream[i:], 'tenement', cd['nprocs'])
...
if __name__=='__main__':
    ...
    else: raise SystemExit('usage: kernelelf|kend|modtiny|modspinner|modworker|modworker_ten|modspinner|modhostile|modhostileread|grade|gradehead|gradeten|gradehostile|rollcall|tenement|ncells')
